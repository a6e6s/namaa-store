...
<div class="right_col" role="main">
    ...
    <?php flash('donationcategory_msg');?>
    ...
    <div class="row">
        ...
        <form action="<?php echo ADMINURL . '/donations/add'; ?>" method="post" enctype="multipart/form-data" accept-charset="utf-8" >
            <div class="col-lg-8 col-sm-12 col-xs-12">
                <div class="form-group  <?php echo (empty($data['name_error'])) ?: 'has-error'; ?>">
                    <label class="control-label" for="pageTitle">عنوان التبرع : </label>
                    <div class="has-feedback">
                        <input type="text" class="form-control" name="name" placeholder="عنوان التبرع" value="<?php echo $data['name']; ?>">
                ...
                <div class="form-group <?php echo (!empty($data['category_id_error'])) ? 'has-error' : ''; ?>">
                    ...
                    <div class="has-feedback">
                        <select name="category_id" class="form-control">
                            <option value="">اختار قسم التبرع </option>
                ...
                <div class="">
                    <label class="control-label" for="imageUpload">صور التبرع : </label>
                ...
                <div class="form-group <?php echo (empty($data['secondary_image_error'])) ?: 'has-error'; ?>">
                    <label class="control-label" for="imageUpload"> صورة التبرع الخارجية : </label>
                ...
                <div class="form-group">
                    <label class="control-label">وصف التبرع  : </label>
                    ...
                    <div class="card">
                        ...
                        <div id="collapseZero" class="collapse in card-body" aria-labelledby="headingZero" >
                            ...
                            <div class="form-group <?php echo (!empty($data['payment_methods_error'])) ? 'has-error' : ''; ?>">
                                <label class="control-label">وسائل الدفع المعتمدة للتبرع :</label>
                                <div class="radio">
                                    <?php
                    ...
                    <div class="card">
                        ...
                        <div id="collapseTwo" class="collapse card-body" aria-labelledby="headingTwo" >
                            ...
                            <div class="form-group">
                                ...
                                <div class=" form-group">
                                    <textarea name="meta_description" class="form-control description" placeholder="ادرج وصف مختصر عن التبرع"><?php echo $data['meta_description']; ?></textarea>
                                </div>
                            </div>
                            <div class="form-group">
