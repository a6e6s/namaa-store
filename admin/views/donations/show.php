    ...
    <div class="row">
        <div class="col-md-12 col-sm-12">
            ...
            <div class="form-groupcol-xs-12">
                ...
                <p class=""><?php if ($data['donation']->gift) {echo $data['donation']->gift_data; }?></p>
            </div>
            <div class="form-groupcol-xs-12">
                <label class="control-label">بيانات الدفع من خلال بايفورت : </label>
                <p><?php echo $data['donation']->meta; ?></p>
            </div>
            <div class="form-groupcol-xs-12">
                <label class="control-label">اسم المشروع : </label>
                <p><?php echo $data['donation']->gift_data; ?></p>
            </div>
            <div class="form-groupcol-xs-12">
