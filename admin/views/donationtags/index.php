...
<div class="right_col" role="main">
    ...
    <div class="page-title">
        ...
        <div class="title_left">
            <a href="<?php echo ADMINURL; ?>/donationtags/add" class="btn btn-success pull-left">انشاء جديد <i class="fa fa-plus"></i></a>
        </div>
    </div>
            ...
            <form action="" method="post" >
                <div class="table-responsive">
                    <table class="table table-striped jambo_table bulk_action">
                        ...
                        <tbody>
                            <?php foreach ($data['donationtags'] as $tag): ?>
                                <tr class="even pointer">
                                    ...
                                    <td class="form-group">
                                        <?php
                                        if (!$tag->status) {
                                            echo '<a href="' . ADMINURL . '/donationtags/publish/' . $tag->tag_id . '" class="btn btn-xs btn-warning" type="button" data-toggle="tooltip" data-original-title="غير منشور"><i class="fa fa-ban"></i></a>';
                                        } elseif ($tag->status == 1) {
                                            echo '<a href="' . ADMINURL . '/donationtags/unpublish/' . $tag->tag_id . '" class="btn btn-xs btn-success" type="button" data-toggle="tooltip" data-original-title="منشور"><i class="fa fa-check"></i></a>';
                                        }
                                        ?>
                                        <a href="<?php echo ADMINURL . '/donationtags/show/' . $tag->tag_id; ?>" class="btn btn-xs btn-success" data-placement="top" data-toggle="tooltip" data-original-title="عرض"><i class="fa fa-eye"></i></a>
                                        <a href="<?php echo ADMINURL . '/donationtags/edit/' . $tag->tag_id; ?>" class="btn btn-xs btn-primary" data-placement="top" data-toggle="tooltip" data-original-title="تعديل"><i class="fa fa-edit"></i></a>
                                        <a href="<?php echo ADMINURL . '/donationtags/delete/' . $tag->tag_id; ?>" class="btn btn-xs btn-danger" data-placement="top" data-toggle="tooltip" data-original-title="حذف" onclick="return confirm('Are you sure?') ? true : false"><i class="fa fa-trash-o"></i></a>
                                    </td>
                                </tr>
                            <?php endforeach;?>
                            ...
                            <tr class="tab-selected">
                                ...
                                <th class="column-title"  colspan= "1"> عرض
                                    <select name="perpage" onchange="if (this.value)
                                                window.location.href = '<?php echo ADMINURL . '/donationtags/index/' . $data['current']; ?>' + '/' + this.value">
                ...
                <ul class="pagination text-center">
                    <?php
                    pagination($data['recordsCount'], $data['current'], $data['perpage'], 4, ADMINURL . '/donationtags');
                    ?>
                </ul>
