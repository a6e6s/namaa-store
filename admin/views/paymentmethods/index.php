...
<div class="right_col" role="main">
    ...
    <div class="page-title">
        ...
        <div class="title_left">
            <a href="<?php echo ADMINURL; ?>/paymentmethods/add" class="btn btn-success pull-left">انشاء جديد <i class="fa fa-plus"></i></a>
        </div>
    </div>
        ...
        <div class="col-md-12 col-sm-12 col-xs-12">
            ...
            <form action="" method="post" >
                            ...
                            <tr class="tab-selected">
                                ...
                                <th class="column-title"> عرض
                                    <select name="perpage" onchange="if (this.value)
                                                window.location.href = '<?php echo ADMINURL . '/paymentmethods/index/' . $data['current']; ?>' + '/' + this.value">
                ...
                <ul class="pagination text-center">
                    <?php
pagination($data['recordsCount'], $data['current'], $data['perpage'], 4, ADMINURL . '/paymentmethods');
?>
                </ul>
