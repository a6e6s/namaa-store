...
class Project extends Model
{
    ...
    {
        $this->db->query('INSERT INTO donations ( amount, payment_method_id, hash, project_id, donor_id, status, modified_date, create_date)'
            . ' VALUES (:amount, :payment_method_id, :hash, :project_id, :donor_id, :status, :modified_date, :create_date)');
        // binding values
