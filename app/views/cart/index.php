...
<div class="msg"><?php flash('msg');?></div>
 <form method="post" action="<?php root('projects');?>/redirect" id="pay">    <div class="card-header text-center">
...
?>
            ...
            <tfoot>
                ...
                <th colspan="2"><?php if (isset($_SESSION['cart']['totalQty'])) {
...
<div class="msg"></div>
        ...
        <div class="form-group row mt-4">
            ...
            <div class="col-sm-10">
                ...
                <input type="hidden" name="project_id" value="<?php ?>" id="project_id">
